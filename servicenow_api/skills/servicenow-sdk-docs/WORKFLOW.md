...
Visit the [discussions]([configured-endpoint]) section!

### Links

[NPM Package]([configured-endpoint])

[Documentation]([configured-endpoint])

[Release Notes]([configured-endpoint])

[Community Forum]([configured-endpoint])

[SDK Examples]([configured-endpoint])


<h1 align="center">
ServiceNow SDK Samples
</h1>
This repository contains sample code illustrating the [ServiceNow SDK]([configured-endpoint]) and Fluent language. You can read, play with or adapt from these samples to create your own application.
## Prerequisites
- [node]([configured-endpoint]) v20+
- [pnpm]([configured-endpoint]) v9+
## Usage
- `git clone [configured-endpoint]`
