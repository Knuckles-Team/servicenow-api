# React UIPage API Sample

This example shows the usage of the `UIPage` Fluent interface for creating UI Pages with React in ServiceNow.

## Example Location
Source Code: [assets/samples/react-ui-page-ts-sample](../assets/samples/react-ui-page-ts-sample)

## Code Samples

### `index.now.ts`
Path: [react-ui-page-ts-sample/fluent/index.now.ts](../assets/samples/react-ui-page-ts-sample/fluent/index.now.ts)
...
### `incident.now.ts`
Path: [react-ui-page-ts-sample/fluent/tables/incident.now.ts](../assets/samples/react-ui-page-ts-sample/fluent/tables/incident.now.ts)
...
export const x_reactuisample_incident = Table({
...
Path: [react-ui-page-ts-sample/fluent/ui-pages/incident-manager.now.ts](../assets/samples/react-ui-page-ts-sample/fluent/ui-pages/incident-manager.now.ts)
